...
const ChatBox = () => {
  const { userData, chatUser, messages, setMessages, messagesId,chatVisible,setChatVisible } =
  ...
  return chatUser ? (
    <div className={`chat-box ${chatVisible?"":"hidden"} `}>
      <div className="chat-user">
        ...
        <p>
          {chatUser.userData.name}{Date.now()-chatUser.userData.lastSeen<=70000?<img className="dot" src={assests.green_dot} alt="" />:null}
